...
namespace ShoeStore.Web.manage.View
{
    public partial class TransactionLog : BasePage
    {
        ...
        public override void SonLoad()
        {
            ...
            tlog = new BLL.TransactionLog();
            IList<MODEL.TransactionLog> list=tlog.PageTLog(pageIndex,10,out PageCount,out num);
