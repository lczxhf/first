<%@ Page Title="" Language="C#" MasterPageFile="~/manage/View/common.Master" AutoEventWireup="true" CodeBehind="SuperUser.aspx.cs" Inherits="ShoeStore.Web.manage.View.SuperUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="placeHead" runat="server">
    <script type="text/javascript">
        var targetUrl = "/manage/Action/SuperUser.ashx";
        //当前正在被操作的 行dom对象
        var $nowRow = null;
            ...
            $.post(targetUrl, data + "&type=m", function (jsObj) {
                ...
                processData(jsObj, function () {
                    ...
                    if ($nowRow != null) {
                        ...
                        $tds[2].innerHTML = jsObj.data.PassWord;
                        //清空选中行
                        $nowRow = null;
                    }
                });
        ...
        function showEditPanel(mid, btn) {
            ...
            $.get(targetUrl, { type: "get", "mid": mid, s: Math.random() }, function (jsObj) {
                ...
                processData(jsObj, function () {
                    ...
                    $("#Name").val(jsObj.data.Name);
                    $("#PassWord").val(jsObj.data.PassWord);
...
<asp:Content ID="Content2" ContentPlaceHolderID="placeRight" runat="server">
        ...
        <table id="tbList">
    <tr id="trNav"><th colspan="3">当前正在：【管理员用户】管理</th><th><input type="button" id="btnAdd" value="新增" /></th></tr>
    <tr>
        <th>Id</th>
        <th>用户名</th>
        <th>密 码</th>
    ...
    <!--循环生成行-->
        ...
        <!--模态窗口 Begin-->
<!--01.修改窗口-->
<div id="dialogModify" title="管理员管理" clas="dialogPanel">
    <form id="fModify">
